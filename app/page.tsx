      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Content creators choose Kutumbhcraft
              <br />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-premium p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                "The SEO optimization is incredible. My Kutumbhcraft articles consistently 
            ...
            <Card className="border-0 shadow-premium p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                Kutumbhcraft specializes in AI comparisons better than any general tool."
              </p>
              <div className="flex text-yellow-400 mt-4">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 fill-current" />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="flex items-center space-x-2 mb-6">
                  ...
                  <span className="text-2xl font-bold">Kutumbhcraft</span>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-6">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <p className="text-gray-400 text-sm">
                  &copy; 2025 Kutumbhcraft. All rights reserved.
                </p>
